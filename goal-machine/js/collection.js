...
(function () {
  ...
  const A = [
    ...
    ['bull', '🎯', 'Bullseye', 'Hit a Target exactly.', e => e.type === 'draft' && e.bull],
    ['close', '📏', 'Near Miss', 'Finish within 10 goals (or equivalent) of a Target.', e => e.type === 'draft' && e.closeness != null && e.closeness <= 10],
