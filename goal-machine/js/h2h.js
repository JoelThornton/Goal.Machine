...
(function () {
  ...
  function setupScreen(root) {
    ...
    root.innerHTML = `<div class="topbar"><a href="#/" class="back">‹</a><h2>⚔️ Head to Head</h2><span></span></div>
      <div class="variant-row"><span class="on">📱 Same phone</span><a href="#/online">🌐 Online${GM.store.get('onlineWaiting', 0) ? ` <i class="online-badge">${GM.store.get('onlineWaiting', 0)}</i>` : ''}</a></div>
