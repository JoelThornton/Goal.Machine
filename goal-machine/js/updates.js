  ...
  GM.UPDATES = [
    {
      ...
      items: [
        ...
        '🌐 Playing a mate online is simpler: New game is two steps (pick a game, then who against), with the two easiest games first and the rest under More games. First-timers get a quick how-it-works and can join with a code straight from the Games tab',
