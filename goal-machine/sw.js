...
const SHELL = ['./', 'index.html', 'style.css', 'config.js', 'data/players.js', 'js/core.js', 'js/draft.js', 'js/report.js', 'js/collection.js', 'js/modes.js', 'js/h2h.js', 'js/updates.js', 'js/app.js',
