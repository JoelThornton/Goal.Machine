...
const CACHE = 'goal-machine-v20';
const SHELL = ['./', 'index.html', 'style.css', 'config.js', 'data/players.js', 'data/photos.js', 'data/faces.js', 'js/core.js', 'js/audio.js', 'js/daily.js', 'js/draft.js', 'js/report.js', 'js/collection.js', 'js/modes.js', 'js/h2h.js', 'js/online.js', 'js/picture.js', 'js/market.js', 'js/updates.js', 'js/app.js',
