...
const CACHE = 'goal-machine-v12';
const SHELL = ['./', 'index.html', 'style.css', 'config.js', 'data/players.js', 'js/core.js', 'js/draft.js', 'js/report.js', 'js/collection.js', 'js/modes.js', 'js/app.js',
